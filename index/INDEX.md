...
- **收录时间**: 2026-04-23
- **文档**: [极简命运星盘塔罗海报Overlord角色剪影-20260423.md](../prompts/movie-poster/极简命运星盘塔罗海报Overlord角色剪影-20260423.md)
- **效果图**: [查看](../prompts/movie-poster/assets/20260423-极简命运星盘塔罗海报-安兹.jpg)
- **质量**: ⭐ 优质

**提示词**:

> 根据【角色/主题】生成一张收藏级极简命运星盘 / 塔罗海报。画面中央为该角色巨大、优雅、完整的人物剪影式主视觉...
...
- **分类**: UI
- **作者**: @alanlovelq
- **来源**: X (Twitter) - [原文链接](https://x.com/alanlovelq/status/2046048929490612464)
- **标签**: gpt-image-2, UI, 截图, 直播, 淘宝, 小红书
- **收录时间**: 2026-04-23
- **文档**: [多场景UI截图-20260423.md](../prompts/ui/多场景UI截图-20260423.md)
- **效果图**: [查看](../prompts/ui/assets/多场景UI截图-效果图.jpg)
- **质量**: ✅ 中等

**提示词**:

> 1、生成特朗普和金正恩在抖音直播间打PK的截图  2、生成不知火舞的小红书主页截图...
